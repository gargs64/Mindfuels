        ...
        $stmt = $pdo->prepare("
            INSERT INTO products
              (product_id, title, tag1, tag2, tag3, mrp, sp, stock_qty, description,
               image1, image2, image3, image4, image5, image6, image7, weight, length, width, height)
            VALUES
              (:pid, :title, :tag1, :tag2, :tag3, :mrp, :sp, :stock, :desc,
               :img1, :img2, :img3, :img4, :img5, :img6, :img7, :weight, :length, :width, :height)
            ON DUPLICATE KEY UPDATE
              ...
              image7=VALUES(image7), weight=VALUES(weight), length=VALUES(length),
